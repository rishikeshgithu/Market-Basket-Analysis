...
def main():
    ...
    if uploaded_file is not None:
        ...
        # Display results in a tabular format using Streamlit
        st.subheader("SKU Name Analysis")
        ...
        st.write(sku_name_sorted_results[[sort_by]])

        st.subheader("Brand Name Analysis")
        ...
        st.write(brand_name_sorted_results[[sort_by]])
        ...
        st.write(category_sorted_results[[sort_by]])
